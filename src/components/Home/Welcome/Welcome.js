...
function Welcome() {
  ...
  return (
    <div>
        <div className='md:bg-cover md:bg-no-repeat md:bg-center sm:bg-cover  welcome-container'>  
            <div className='md:pt-0 md:m-0  welcome-parent'>

                <div className='  welcome-details-name'>
                    <span className='md:text-4xl sm:text-3xl    primary-text'>
                ...
                <div  className='  welcome-details-tagline'>
                    <div className='md:text-sm sm:text-xs   tagline-line'>
